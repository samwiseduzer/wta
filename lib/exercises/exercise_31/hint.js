...
module.exports = function(){
    console.log(chalk.yellow(
        ...
        3) Every character in a string has a numerical value called its "character code". Consider using the .getCharCodeAt() method to determine the value of the letter
